...
#	logging.basicConfig(level=logging.DEBUG)
	...
	try:
		app=Document(urlfile.read(), debug=False).summary().encode('ascii','ignore')
		print app
	finally:
		urlfile.close()
		return app
...
# readability('http://www.repubblica.it/politica/2013/04/04/news/pd_spaccato_dopo_parole_renzi-55917078/')
