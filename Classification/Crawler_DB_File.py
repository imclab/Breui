...
# ATTENZIONE VERSIONE PRECEDENTE
...
#         return title + notiziastr
    ...
    def createFile(self,httpSoup,saveDir):
        ...
        soup_text = httpSoup.get_text()
        # Lo rende Unicode
        html = httpSoup.prettify()
        readable_article = Document(html).summary()
#        readable_title = Document(html).short_title()
#         html_simple = Document(html, debug=False).summary().encode('ascii','ignore')
#         soup_html_simple =  BeautifulSoup(html_simple)
        soup_html_simple = BeautifulSoup(readable_article)
        raw  = soup_html_simple.get_text()
